...
**Stato corrente:** TODO-0001, TODO-0002 e TODO-0003 completate; TODO-0101 è `IN_ANALYSIS`. Il consolidamento decisionale è integrato in `main`, mentre Schema Architecture, cataloghi e matrici finali restano da produrre prima di rendere la task `READY`.
**Sostituisce:** `Project_Integrity_OS_TODO_MVP_v0_8.md`
...
**Brief utilizzato:** `Project_Integrity_OS_Brief_TODO-0002_v0_2_SUPERSEDED.md`
...
**Prompt utilizzato:** `Project_Integrity_OS_Prompt_Esecutivo_Browser_TODO-0002_v0_1_FINAL.md`
...
**Indice locale:** `docs/10-executions/TODO-0101/README.md`

Il modello consolidato distingue:
...
Nel primo MVP usa due database SQLite fisici:
...
Sono già documentati, in forma DRAFT:

- separazione tra task execution e attempt;
- UUID e reference code;
- gerarchia del lavoro;
- Context Package versionato;
- provenienza multidimensionale;
- requirements, acceptance criteria, test, evidence, verification, validation e approval;
- lifecycle delle decisioni;
- registro comune per question, assumption, risk, finding, conflict e bug;
- journal degli eventi e ricostruzione temporale;
- integrità anti-orfano;
- conservazione, rettifiche, redazione e cancellazione;
- ruoli, binding, permessi, scope e separation of duties;
- transition engine;
- cardinalità strutturali e minimi di lifecycle;
- schema canonico completo e implementazione fisica progressiva.

La task non è ancora `READY` e non autorizza implementazione SQLite.
...
- i deliverable finali sono completi e reciprocamente coerenti;
- ogni entità, relazione, cardinalità e vincolo è definito;
- la separazione CONTROL/PROJECT DATABASE è formalizzata;
- i riferimenti globali senza FK cross-database sono definiti;
- i tipi sono compatibili con una futura migrazione PostgreSQL;
- non esiste dipendenza da `rowid`;
- gli open issue sono risolti o assegnati esplicitamente a TODO-0102/TODO-0103;
- il brief esecutivo è approvato;
- la task viene portata a `READY` mediante decisione esplicita.
