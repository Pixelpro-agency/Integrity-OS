...
| DOC-034 | To-Do | Project_Integrity_OS_TODO_MVP_v0_6.md | v0.6 | ACTIVE | Sì | Project_Integrity_OS_TODO_MVP_v0_5.md | Globale | docs/00-current/ | Baseline preliminare approvata; TODO-0003 READY |
| DOC-035 | Registro | Project_Integrity_OS_Document_Registry_v0_4.md | v0.4 | ACTIVE | Sì | Project_Integrity_OS_Document_Registry_v0_3.md | Globale | docs/00-current/ | Registro aggiornato prima dell'avvio di TODO-0003 |
