...
## To-Do del primo MVP — v0.1

**Documento di riferimento:** `Project_Integrity_OS_Flussi_MVP_v0_1.md`  
**Regola:** ogni voce indica i paragrafi funzionali a cui è collegata.  
**Stato iniziale:** tutte le attività sono `TODO`, salvo diversa indicazione.
...
**Riferimenti:** FL-02, FL-03, FL-21  
**Priorità:** P0  
**Dipende da:** TODO-0002  
**Stato:** TODO
...
- logging;
- migrazioni;
- regola dei tre tentativi per task esecutive;
- formato obbligatorio dei report di sviluppo.

**Done quando:**

- comandi di controllo documentati;
- test di esempio passano;
- report standard approvato.
...
# EPIC 11 — Funzioni rinviate

## TODO-1101 — Adapter orchestratore AI

**Riferimenti:** FL-02.1, FL-08, FL-23  
**Priorità:** DEFERRED  
**Stato:** TODO

---

## TODO-1102 — Analisi semantica con IA
...
## TODO-1103 — PostgreSQL/Supabase adapter
...
## TODO-1104 — Collaborazione cloud
