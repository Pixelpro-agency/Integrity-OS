...
## Flussi funzionali del primo MVP — v0.2 FROZEN

**Stato:** APPROVATO E CONGELATO per il primo vertical slice  
...
## Controllo delle modifiche alla specifica

La presente versione costituisce la baseline funzionale approvata del primo vertical slice.

Da questo momento:

- le correzioni editoriali che non cambiano il significato possono essere registrate come revisione minore;
- ogni variazione di obiettivo, non-obiettivi, criteri di accettazione o principio deterministic-first richiede una decisione esplicita;
- le variazioni approvate devono aggiornare sia questo documento sia la To-Do collegata;
- nessuna task esecutiva può introdurre silenziosamente funzionalità rinviate in FL-23;
- l'assenza di API IA nel primo vertical slice è un vincolo obbligatorio.
...
**Decisione:** il perimetro descritto in questa versione è approvato come base di sviluppo.  
**Task collegata:** TODO-0001 — completata.  
**Prossima task autorizzata:** TODO-0002 — creazione della struttura iniziale Tauri 2.
