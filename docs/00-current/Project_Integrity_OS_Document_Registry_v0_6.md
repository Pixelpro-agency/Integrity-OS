...
| DOC-020 | To-Do | Project_Integrity_OS_TODO_MVP_v0_5.md | v0.5 | SUPERSEDED | No | Project_Integrity_OS_TODO_MVP_v0_4.md | Globale | docs/20-history/todo/ | TODO-0003 ancora non avviata; sostituita dalla v0.6 |
...
| DOC-031 | Registro | Project_Integrity_OS_Document_Registry_v0_3.md | v0.3 | SUPERSEDED | No | Project_Integrity_OS_Document_Registry_v0_2.md | Globale | docs/20-history/registry/ | Registro della baseline conclusiva di TODO-0002 |

| DOC-032 | Analisi preliminare | Project_Integrity_OS_Modello_Informativo_Pre-TODO-0003_v0_1.md | v0.1 | SUPERSEDED | No, come storico decisionale | — | Pre-TODO-0003 | docs/20-history/analysis/ | Analisi consolidata dal documento DOC-033 |
| DOC-033 | Standard operativo | Project_Integrity_OS_Prompt_Report_Rule_Catalog_Lifecycle_v0_1.md | v0.1 | APPROVED | Sì | Project_Integrity_OS_Modello_Informativo_Pre-TODO-0003_v0_1.md | TODO-0003 e task successive | docs/00-current/ | Baseline vincolante per Prompt Schema, Report Schema, Rule Catalog e lifecycle dei tentativi |
| DOC-034 | To-Do | Project_Integrity_OS_TODO_MVP_v0_6.md | v0.6 | SUPERSEDED | No | Project_Integrity_OS_TODO_MVP_v0_5.md | Globale | docs/20-history/todo/ | TODO-0003 READY; sostituita dalla v0.7 |
| DOC-035 | Registro | Project_Integrity_OS_Document_Registry_v0_4.md | v0.4 | SUPERSEDED | No | Project_Integrity_OS_Document_Registry_v0_3.md | Globale | docs/20-history/registry/ | Registro precedente alla chiusura di TODO-0003 |
| DOC-036 | Prompt | Project_Integrity_OS_Prompt_Esecutivo_Browser_TODO-0003_v0_1.md | v0.1 | FINAL | Sì, come storico autentico della task | — | TODO-0003 | docs/10-executions/TODO-0003/instructions/ | Prompt realmente utilizzato; non riutilizzare come modello operativo senza considerare DOC-046 |
| DOC-037 | Convenzioni tecniche | Project_Integrity_OS_Convenzioni_Tecniche_v0_1.md | v0.1 | SUPERSEDED | No | — | TODO-0003 e task successive | docs/20-history/technical-conventions/ | Baseline iniziale; sostituita dalla v0.2 |
| DOC-038 | Standard report | Project_Integrity_OS_Standard_Report_Sviluppo_v0_1.md | v0.1 | SUPERSEDED | No | — | TODO-0003 e task successive | docs/20-history/report-standards/ | Standard iniziale; sostituito dalla v0.2 |
| DOC-039 | Report | Project_Integrity_OS_Report_Esecutivo_TODO-0003_v0_1.md | v0.1 | FINAL | Sì, come report originale/raw dell'esecutore | — | TODO-0003 | docs/10-executions/TODO-0003/reports/ | Conservato immutabile; verifica e integrazioni sono documenti separati |
| DOC-040 | Verifica | Project_Integrity_OS_Verifica_Indipendente_TODO-0003_v0_1.md | v0.1 | FINAL | Sì | — | TODO-0003 | docs/10-executions/TODO-0003/reports/ | Verifica indipendente superata |
| DOC-041 | Approvazione | Project_Integrity_OS_Approvazione_Umana_TODO-0003_v0_1.md | v0.1 | FINAL | Sì | — | TODO-0003 | docs/10-executions/TODO-0003/validation/approvals/ | Approvazione della chiusura e del commit locale |
| DOC-042 | To-Do | Project_Integrity_OS_TODO_MVP_v0_7.md | v0.7 | SUPERSEDED | No | Project_Integrity_OS_TODO_MVP_v0_6.md | Globale | docs/20-history/todo/ | TODO-0003 DONE prima della correzione post-chiusura |
| DOC-043 | Registro | Project_Integrity_OS_Document_Registry_v0_5.md | v0.5 | SUPERSEDED | No | Project_Integrity_OS_Document_Registry_v0_4.md | Globale | docs/20-history/registry/ | Registro precedente alla correzione post-chiusura di TODO-0003 |

| DOC-044 | Convenzioni tecniche | Project_Integrity_OS_Convenzioni_Tecniche_v0_2.md | v0.2 | ACTIVE | Sì | Project_Integrity_OS_Convenzioni_Tecniche_v0_1.md | TODO-0003 e task successive | docs/00-current/ | Completa naming e convenzioni per future migrazioni |
| DOC-045 | Standard report | Project_Integrity_OS_Standard_Report_Sviluppo_v0_2.md | v0.2 | ACTIVE | Sì | Project_Integrity_OS_Standard_Report_Sviluppo_v0_1.md | TODO-0003 e task successive | docs/00-current/ | Include esplicitamente il controllo staged e tutela il report originale |
| DOC-046 | Nota post-chiusura | Project_Integrity_OS_Nota_Post_Chiusura_TODO-0003_v0_1.md | v0.1 | FINAL | Sì | — | TODO-0003 | docs/10-executions/TODO-0003/validation/notes/ | Registra finding documentali, autenticità degli storici, commit e presenza remota osservata |
| DOC-047 | To-Do | Project_Integrity_OS_TODO_MVP_v0_8.md | v0.8 | ACTIVE | Sì | Project_Integrity_OS_TODO_MVP_v0_7.md | Globale | docs/00-current/ | Registra la correzione documentale post-chiusura di TODO-0003 |
| DOC-048 | Registro | Project_Integrity_OS_Document_Registry_v0_6.md | v0.6 | ACTIVE | Sì | Project_Integrity_OS_Document_Registry_v0_5.md | Globale | docs/00-current/ | Registro aggiornato dopo la correzione post-chiusura di TODO-0003 |
